...
def Setting():
    parser = argparse.ArgumentParser(description="Train CDAT")
    parser.add_argument("--model_title", type=str, default='CDAT')
    ...
    parser.add_argument("--ShareUserNum", type=int, default=1231)    #1231 967 1859
    parser.add_argument("--lr", type=float, default=0.0001)         #0.0001    0.0001   0.0001
    parser.add_argument("--DFi_lr", type=float, default=0.0003)     #0.0003    0.0003   0.0001   D_phi
    parser.add_argument("--GI_lr", type=float, default=0.0003)      #0.0003    0.0003   0.0001
    parser.add_argument("--DPe_lr", type=float, default=0.0001)     #0.0001    0.0001   0.0001   D_psi
    parser.add_argument("--GA_lr", type=float, default=0.0001)      #0.0001    0.0001   0.0001
    parser.add_argument("--lada", type=float, default=0.1)  #0.1 0.3 0.1
    parser.add_argument("--device", type=str, default="cuda:0")
    parser.add_argument("--loadpath", type=str, default='Datasets/S1/1/')  #SharedDatasets   Datasets_sparse
    parser.add_argument("--savepath", type=str, default="test/S1-1-0618-lada0.1-wopsi/")   #S1 == Movie-Book S2 == Movie-Music  S3 == TV-CD
    #parser.add_argument("--loadmodelpath", type=str, default="ARCDR3/S1/S1-1-0617-lada7/model_para_epoch13.pth")
    ...
    parser.add_argument("--SaveDanGrad", type=str, default=args.savepath + "Dan_grad.txt")
    parser.add_argument("--SaveCdanGrad", type=str, default=args.savepath + "Cdan_grad.txt")
